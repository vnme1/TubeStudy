...
| **딴짓 방지 알림**   | 영상 제목에 _Vlog/게임/먹방_ 등 딴짓 키워드 포함 시 Chrome 알림 발생               | 문제 해결 능력, 비즈니스 로직(딴짓 분류) 구현    |
...
> 서버 기본 주소: **[http://localhost:18085](http://localhost:18085)**
...
- 딴짓 키워드 포함 영상 시
  → Chrome 알림 표시
- 학습 현황·통계를 보려면
  → **[http://localhost:18085](http://localhost:18085)** 접속
